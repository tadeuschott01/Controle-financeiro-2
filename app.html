...
<head>
  ...
  <meta name="theme-color" content="#0b3f2d">
  <meta name="description" content="ControleS — Seu dinheiro sob controle.">
  <title>ControleS — Seu dinheiro sob controle</title>  <link rel="preconnect" href="https://fonts.googleapis.com">
  <link rel="preconnect" href="https://fonts.gstatic.com" crossorigin>  <link
    href="https://fonts.googleapis.com/css2?family=Inter:wght@400;500;600;700;800&display=swap"
    rel="stylesheet"
  >  <script src="https://cdn.jsdelivr.net/npm/@supabase/supabase-js@2"></script>  <script src="https://cdn.jsdelivr.net/npm/chart.js@4.4.7/dist/chart.umd.min.js"></script>  <link rel="stylesheet" href="app.css">
</head><body>  <!-- =====================================================
       LOGIN
  ====================================================== -->  <div id="loginView" class="auth-page"><div class="auth-card">
  ...
  <div class="brand-block">
    ...
    <div class="brand-logo">
      ...
      <span class="logo-fallback-mark">C↗</span>
  ...
  <div class="auth-heading">
    ...
    <p>Acompanhe suas finanças de onde estiver.</p>
  ...
  <div class="security-note">
    ...
    Controle financeiro simples, inteligente e seguro.
       ...
       CADASTRO
  ====================================================== -->  <div id="registerView" class="auth-page hidden"><div class="auth-card">
  ...
  <div class="auth-heading">
    ...
    <p>Organize seu dinheiro de um jeito simples.</p>
...
<main class="main-content">
    ...
    <div class="filters panel">
      ...
      <div class="filters-header">
        ...
        <div>
          ...
          <p>
            Combine período, tipo, categoria e pesquisa.
          </p>

        </div>

        <button
          id="clearTransactionFiltersBtn"
          class="text-button"
          type="button"
        >
          Limpar filtros
      ...
      <div
        id="transactionFilterSummary"
        class="filter-summary"
        aria-live="polite"
      >
        Mostrando todos os lançamentos do período.
      </div>
    ...
    <div class="panel table-panel">
      ...
      <div class="panel-header">
        ...
        <div>
          ...
          <p>
            Receitas lançadas que ainda não entraram no saldo.
          </p>
  ...
  >
    ...
    <div class="period-filter panel report-period-filter">
    ...
    <div
      ...
      class="premium-report-gate hidden"
    >
      ...
      <p>
        Ative o Premium para liberar análises avançadas.
      </p>
  ...
  >
    ...
    <div class="premium-hero">
      ...
      <h2>
        Tenha mais controle sobre seu dinheiro.
      </h2>

      <p>
        Desbloqueie recursos avançados do ControleS
        e acompanhe suas finanças com ainda mais detalhes.
      </p>
    ...
    <div class="premium-features">
      ...
      <article>
        ...
        <div>
          ...
          <p>
            Veja análises detalhadas das suas movimentações.
          </p>
      ...
      <article>
        ...
        <div>
          ...
          <p>
            Crie e acompanhe objetivos para seu dinheiro.
          </p>
      ...
      <article>
        ...
        <div>
          ...
          <p>
            Veja automaticamente quanto sobrou no mês.
          </p>
      ...
      <article>
        ...
        <div>
          ...
          <p>
            Acompanhe receitas, despesas e sobra do mês.
          </p>
...
>
  ...
  <p>
    Durante os testes, o Premium será ativado por 7 dias.
    A cobrança real será integrada posteriormente.
  </p>
